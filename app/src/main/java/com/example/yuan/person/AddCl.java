    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id)
            {
                if( imageItem.size() == 10) { //第一张为默认图片
                    Toast.makeText(AddCl.this, "图片数9张已满", Toast.LENGTH_SHORT).show();
                }
                else if(position == 0) { //点击图片位置为+ 0对应0张图片
                    Toast.makeText(AddCl.this, "添加图片", Toast.LENGTH_SHORT).show();
                    //选择图片
        ...
        btnadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(AddCl.this,"添加成功",Toast.LENGTH_SHORT).show();
                Intent intent = new Intent();
                intent.setClass(AddCl.this,AddXiao.class);
                Toast.makeText(AddCl.this,"添加成功",Toast.LENGTH_SHORT).show();
                //---------------   获取图片资源------------------------------------------
...
//
    ...
    protected void dialog(final int position) {
        AlertDialog.Builder builder = new AlertDialog.Builder(AddCl.this);
