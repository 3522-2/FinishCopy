...
//
//public class AddXiao_wuxiao extends AppCompatActivity {
...
//                intent.setClass(AddXiao_wuxiao.this, gaunliyuanMain.class);
...
//                    Toast.makeText(AddXiao_wuxiao.this, "图片数9张已满", Toast.LENGTH_SHORT).show();
//                }
//                else if(position == 0) { //点击图片位置为+ 0对应0张图片
//                    Toast.makeText(AddXiao_wuxiao.this, "添加图片", Toast.LENGTH_SHORT).show();
//                    //选择图片
...
//                EffectDAO effectDAO = new EffectDAO(AddXiao_wuxiao.this);
//
//
...
//                Toast.makeText(AddXiao_wuxiao.this,"添加成功",Toast.LENGTH_SHORT).show();
//                Intent intent = new Intent();
//                intent.setClass(AddXiao_wuxiao.this,AddXiao_wuxiao.class);
//                startActivity(intent);
//                finish();
//
//            }
...
//        AlertDialog.Builder builder = new AlertDialog.Builder(AddXiao_wuxiao.this);
