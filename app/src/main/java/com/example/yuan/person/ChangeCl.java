...
public class ChangeCl extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_change_cl);
        ...
        fanhui.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(ChangeCl.this, gaunliyuanMain.class);
    ...
    private void ShowInfo() {
        ...
        MaterialDAO materialDAO = new MaterialDAO(ChangeCl.this);
        // 获取所有收入信息，并存储到List泛型集合中
        List<Material> listinfos = materialDAO.getScrollData(0,
                (int) materialDAO.getCount());
        strInfos = new String[listinfos.size()];// 设置字符串数组的长度
        int m = 0;// 定义一个开始标识
        for (Material material : listinfos) {// 遍历List泛型集合
            // 将收入相关信息组合成一个字符串，存储数组的相应位置
            strInfos[m] =  material.getMaterial_id()+"|    "+material.getMaterial_name()
