...
public class User_JiaoLiu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fanhui.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(User_JiaoLiu.this, Show_ZhuangXiu.class);
     ...
     */
    private void init() {
        msgList.add(new Msg("您好，对呀这个阶段的装修，有有那些地方不满意吗？", Msg.TYPE.RECEIVED));
