    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String pwd = administratorDAO.findPwd(regName);
                if (regName != null && regPwd != null && administratorDAO.CheckIsDataAlreadyInDBorNot(regName)==1&& pwd.equals(regPwd)==false){
                    Toast.makeText(guanliyuanLogin.this, "密码错误，请重新输入", Toast.LENGTH_SHORT).show();
                }
                ...
                }else if(administratorDAO.CheckIsDataAlreadyInDBorNot(regName)==1&& regPwd.equals(pwd)==true){
