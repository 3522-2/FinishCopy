...
public class XGTSouBudge extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xgtsou_budge);
        /**
         * 返回上一个页面
         */
        ...
        fanhui.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("F",feng);
                intent.putExtra("H",hu);
                intent.putExtra("M",mian);
                intent.setClass(XGTSouBudge.this, XGTSou.class);
                startActivity(intent);
            }
        });
        btn = findViewById(R.id.btn1);
        sum1 = findViewById(R.id.sum0);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EffectDAO effectDAO = new EffectDAO(XGTSouBudge.this);
                ...
                if(zhuangTai.equals("未登录") || zhuangTai==null){
                    myDialog=new MyDialog(XGTSouBudge.this,R.style.MyDialog);
                    ...
                    myDialog.setYesOnclickListener("确定", new MyDialog.onYesOnclickListener() {
                        ...
                        public void onYesOnclick() {
                            Intent intent = new Intent();
                            intent.setClass(XGTSouBudge.this,login.class);
                            startActivity(intent);
                            myDialog.dismiss();
                        }
                    });
