...
//            String name = intent.getStringExtra("xigong");
            mSimpleToolbar.setMainTitle(intent.getStringExtra("title"));
            text_adapter.setText(intent.getIntExtra("introduce",0));
            imageView_adapter.setImageResource( intent.getIntExtra("picture",0));
//        }
//        if(number==2) {
//            String name = intent.getStringExtra("xigong");
